...
namespace xpx_chain_sdk::internal::json::dto::download_channels_page {
    ...
    using DownloadChannelsPageDto = VariadicStruct<
            Field<STR_LITERAL("data"), std::vector<DownloadChannelDto>>,
